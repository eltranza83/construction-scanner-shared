...
14. GOOGLE DOCS MASTER & PROJECT PURCHASING ARCHITECTURE (V1 FINAL):
   ...
   - CONVERSATIONAL PRESENTATION: When the user asks purchasing queries (e.g. "show me the full purchasing list", "what's on our purchasing list", "show me the electrical items"), output the items directly in your answer. Never emit [[ACTION:VIEW_FILE:...]] for purchasing list queries unless the user specifically and explicitly asks to open a full-screen file viewer.`;
}
